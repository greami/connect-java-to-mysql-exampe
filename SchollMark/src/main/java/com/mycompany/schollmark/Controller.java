...
public class Controller {
    ...
    public void addMark(Mark mark){
       EntityManager em= emf.createEntityManager();
        ...
        if (this.isMarkInDB(mark.getIdValutation())){
           em.getTransaction().begin();        
    ...
    /**
     * this method read the table in the databse and build a list of
     * Student class
     * @return List of Student from the database
     */
    public List getStudentList(){
       ...
       //we use the questy in the slass student
       //this query select all Student row in the table
       List<Student> ret = em.createNamedQuery("Student.FindAll", Student.class ).getResultList();
       em.close();
